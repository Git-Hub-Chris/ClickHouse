...
ColumnsDescription StorageSystemKafkaConsumers::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        {"exceptions.time", std::make_shared<DataTypeArray>(std::make_shared<DataTypeDateTime64>(6)), "Timestamp when the 10 most recent exceptions were generated."},
        {"exceptions.text", std::make_shared<DataTypeArray>(std::make_shared<DataTypeString>()), "Text of 10 most recent exceptions."},
        {"last_poll_time", std::make_shared<DataTypeDateTime64>(6), "Timestamp of the most recent poll."},
        {"num_messages_read", std::make_shared<DataTypeUInt64>(), "Number of messages read by the consumer."},
        {"last_commit_time", std::make_shared<DataTypeDateTime64>(6), "Timestamp of the most recent poll."},
        {"num_commits", std::make_shared<DataTypeUInt64>(), "Total number of commits for the consumer."},
        {"last_rebalance_time", std::make_shared<DataTypeDateTime64>(6), "Timestamp of the most recent Kafka rebalance."},
