...
private:
    ...
    static constexpr size_t limit_inrange_from_child_index = 10;
    static constexpr size_t limit_inrange_to_child_index = 11;
    static constexpr size_t limit_by_limit_child_index = 12;
    static constexpr size_t limit_by_offset_child_index = 13;
    static constexpr size_t limit_by_child_index = 14;
    static constexpr size_t limit_child_index = 15;
    static constexpr size_t offset_child_index = 16;
